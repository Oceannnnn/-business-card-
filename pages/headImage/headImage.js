...
Page({
   ...
   */
  data: {
    imageSrc: 'http://d.hiphotos.baidu.com/image/pic/item/43a7d933c895d14346f8225a7ef082025aaf0739.jpg',
    returnImage: '',
    isShowImg: false,
    // 初始化的宽高
    ...
    ctx.draw(true, () => {
      ...
      wx.canvasToTempFilePath({
        ...
        success: function(res) {
          ...
          // })
          that.upload(res.tempFilePath, token)
        }
      })
    })
  }, 
  upload(path, token) {
    ...
    wx.uploadFile({
      url: util.url + "Membercard/uploadAvatar",
      filePath: path[0],
      name: 'file',
      header: {
